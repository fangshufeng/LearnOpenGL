...
GLFWwindow *createWindow() {
    // createWindow
    GLFWwindow *window = glfwCreateWindow(SCR_W, SCR_H, "blinn_phong", nullptr, nullptr);
    if (window == nullptr) {
...
#pragma clang diagnostic pop
    ...
    Shader planeShader(FileSystem::getGLSLPath("18-Blinn-Phong光照/01-冯氏光照的bug/phong_light_bug.vs").c_str(),
                      FileSystem::getGLSLPath("18-Blinn-Phong光照/02-blinnPhong/blinn_phong.fs").c_str());
    ...
    planeShader.setFloat("material.blinnShiness", 1.0f);
    ...
    while (glfwWindowShouldClose(window) == false) {
        ...
        planeShader.setBool("isOpenBlinn", blinn);
