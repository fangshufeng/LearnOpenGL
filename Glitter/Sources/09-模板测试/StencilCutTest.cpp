...
#pragma clang diagnostic pop
    ...
    Shader windowShader(FileSystem::getGLSLPath("09-模板测试/stencil_cut_window.vs").c_str(), FileSystem::getGLSLPath("09-模板测试/stencil_cut_window.fs").c_str());
