...
GLFWwindow *createWindow() {
    // createWindow
    GLFWwindow *window = glfwCreateWindow(SCR_W, SCR_H, "离屏渲染MSAA-后期处理", nullptr, nullptr);
    if (window == nullptr) {
...
#pragma clang diagnostic pop
    ...
    Shader quadShader(FileSystem::getGLSLPath("17-抗锯齿/03-离屏渲染MSAA-后期处理/off_screen_post_process.vs").c_str(),
                      FileSystem::getGLSLPath("17-抗锯齿/03-离屏渲染MSAA-后期处理/off_screen_post_process.fs").c_str());
